-- Security Logon Failed Password Expired Generator (Event ID 535)
-- Generates logon failure - account password has expired

return {
    metadata = {
        name = "security.logon_failed_password_expired",
        category = "SECURITY",
        severity = "WARNING",
        recurrence = "INFREQUENT",
        description = "Logon failure - The specified account's password has expired",
        text_template = "Event Type: Failure Audit\nEvent Source: Security\nEvent Category: Logon/Logoff\nEvent ID: 535\nUser: {domain}\\{username}\nComputer: {computer}\nDescription:\nLogon Failure:\n  Reason: The specified account's password has expired\n  User Name: {username}\n  Domain: {domain}\n  Logon Type: {logon_type}\n  Logon Process: {logon_process}\n  Authentication Package: {auth_package}\n  Workstation Name: {workstation}\n  Status code: 0xC0000071\n  Substatus code: 0x0",
        tags = {"security", "logon", "audit", "failure", "password"},
