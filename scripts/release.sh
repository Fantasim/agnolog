...
# Check version sync
echo -e "${BOLD}  Version sync:${NC}"
if ! verify_version_sync; then
    exit 1
fi
echo -e "${GREEN}  All version references match${NC}"
...
echo -e "  2. Running tests and linting"
echo -e "  3. Building standalone binaries for 4 platforms"
echo -e "  4. Packaging archives with checksums"
echo -e "  5. Publishing GitHub Release"
echo ""
