...
class LogTypeRegistry:
    ...
    def get_categories(self) -> List[str]:
        ...
        Categories are dynamically discovered from loaded generators,
        not hardcoded. This allows themes to define their own categories.

        Returns:
            Sorted list of unique category strings (lowercase)
        """
        categories = set()
        for meta in self._registry.values():
            categories.add(meta.category.lower())
